...
TEMPLATES = [
    {
        ...
        "DIRS": [
            ...
            os.path.join(BASE_DIR, "frontend", "templates", "account"),
            os.path.join(BASE_DIR, "frontend", "templates", "socialaccount"),
        ],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
LOGGING = {
    ...
    "loggers": {
        "coursist": {
            "handlers": ["coursist_file", "console_out", "console_err"],
            "level": "DEBUG",
            "propagate": False,
        },
...
ACCOUNT_FORMS = {
    "login": "academic_helper.forms.login_form.CustomLoginForm",
    "signup": "academic_helper.forms.signup_form.CustomSignupForm",
    "reset_password": "academic_helper.forms.password_reset_form.CustomPasswordResetForm",
}
# Social auth
