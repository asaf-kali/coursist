...
from academic_helper.logic.errors import (
    ShnatonParserError,
    HtmlFormatError,
    FetchRawDataError,
)
from academic_helper.models.course import Course, Department, Faculty, University
    ...
    def _fetch_course(self, course_number: int, year: int):
        ...
        for raw_group in raw_data["lessons"]:
            create_course_groups(
                course, year, course_semesters, occurrence_credits, raw_data["notes"], raw_group,
            )
        return course
