...
from academic_helper.models.course import University, Faculty, Department, Course
from academic_helper.models.course_occurrence import CourseOccurrence, Semester
